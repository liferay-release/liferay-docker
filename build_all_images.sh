...
function build_bundle_image {
	...
	then
		bundle_url="releases.liferay.com/dxp/release-candidates/${version}/$(curl --fail --location --show-error --silent "https://releases.liferay.com/dxp/release-candidates/${version}/.lfrrelease-tomcat-bundle")"
	elif is_ga_release && is_release_candidate
	then
		bundle_url="releases.liferay.com/portal/release-candidates/${version}/$(curl --fail --location --show-error --silent "https://releases.liferay.com/portal/release-candidates/${version}/.lfrrelease-tomcat-bundle")"
	fi

	if is_nightly_release "${version}"
	then
		bundle_url="releases.liferay.com/dxp/nightly/$(curl --fail --location --show-error --silent "https://releases.liferay.com/dxp/nightly/.lfrrelease-tomcat-bundle")"
	fi

	if [ -z "${bundle_url}" ]
	then
		bundle_url="releases.liferay.com/dxp/${version}/"$(curl --fail --location --show-error --silent "https://releases.liferay.com/dxp/${version}/.lfrrelease-tomcat-bundle")
	fi
