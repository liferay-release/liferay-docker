...
function build_bundle_image {
	...
	then
		...
		bundle_url="releases.liferay.com/${product_name}/release-candidates/${version}/$(curl --fail --location --show-error --silent "https://releases.liferay.com/${product_name}/release-candidates/${version}/.lfrrelease-tomcat-bundle")"
	fi
