...
function build_bundle_image {
	...
	then
		bundle_url="releases-cdn.liferay.com/dxp/nightly/$(curl --fail --location --show-error --silent "https://releases-cdn.liferay.com/dxp/nightly/.lfrrelease-tomcat-bundle")"
	fi
