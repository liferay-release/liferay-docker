...
function test_package_not_package_jakarta_transform_dependencies {
	...
	_test_package_not_package_jakarta_transform_dependencies "2025.q3.0" "${LIFERAY_COMMON_EXIT_CODE_SKIPPED}"
	_test_package_not_package_jakarta_transform_dependencies "2025.q4.1" "${LIFERAY_COMMON_EXIT_CODE_SKIPPED}"
...
function test_package_package_jakarta_transform_dependencies {
	...
	_test_package_package_jakarta_transform_dependencies "2025.q4.0"
