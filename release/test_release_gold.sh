...
function test_reference_new_releases {
	lc_cd "test-dependencies/actual.liferay-jenkins-ee.build.properties"
	...
	assert_equals \
		"./test-dependencies/actual.liferay-jenkins-ee.build.properties/build.properties" \
		"./test-dependencies/expected.liferay-jenkins-ee.build.properties/build.properties"
}
