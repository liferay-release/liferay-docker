...
function test_product_not_add_ckeditor_license {
	...
	_test_product_not_add_ckeditor_license "7.3.10-u36"
...
function _test_product_add_ckeditor_license {
	...
	assert_equals \
		"$(cat ${_BUNDLES_DIR}/osgi/configs/com.liferay.frontend.editor.ckeditor.web.internal.configuration.CKEditor5Configuration.config)" "licenseKey=\"${LIFERAY_CKEDITOR_LICENSE_KEY}\""
