...
function test_jdk_set_jdk_version_and_parameters {
	...
	_test_jdk_set_jdk_version_and_parameters "7.4.3-ga131" "zulu8" "${_JDK_PARAMETERS_8}"
	_test_jdk_set_jdk_version_and_parameters "7.4.3-ga132" "open-jdk-17.0.2" "${_JDK_PARAMETERS_17}"
}
