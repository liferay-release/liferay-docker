...
function tag_release {
	...
	do
		...
		then
			lc_log ERROR "Unable to create tag $(get_tag_name) in ${repository_owner}/${repository}."
		...
		then
			lc_log ERROR "Unable to create tag reference for $(get_tag_name) in ${repository_owner}/${repository}."
